...
{
     # Function to compile and display more extensive summary statistics,
     # computed by function gx.stats, than function gx.summary1.
     #
     nxx <- length(xx)
     table <- numeric(28)
     ...
     cat("  Extended Summary Stats for: ", xname, "\n  N and number of NAs:\t\t", 
         ...
         table[11], " <-> ", table[12], "\n  Log10 Mean and SD:\t\t", table[8], 
         " & ", table[9], "\n  Median and 95% CLs:\t\t", table[15], " & ", 
